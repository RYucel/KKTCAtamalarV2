...
import { Search, Filter, ArrowUpDown, ChevronDown, ChevronUp, Users, UserPlus, UserMinus, Building2, Activity, Landmark, Download, AlertTriangle } from 'lucide-react';
      ...
      <main className="flex-grow p-6 flex flex-col gap-6 max-w-7xl mx-auto w-full">
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 flex items-start gap-3">
          ...
          <div className="text-sm text-amber-800">
            <strong>Uyarı:</strong> Bu uygulama tamamen hobi amaçlı geliştirilmiş olup, içerdiği veriler resmi gazete kayıtlarından otomatik olarak derlenmiştir. Verilerde eksiklikler veya hatalar olabilir. Kesin ve resmi bilgi için lütfen resmi makamlarla iletişime geçiniz.
          </div>
        </div>
